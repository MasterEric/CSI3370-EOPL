...
; This implementation of PROC was completed through a combination of
; the Essentials of Programming Languages textbook and the previous LET language,
...
(define lexical-spec
  '((white-sp (whitespace) skip) ; If the scanner finds whitespace, skip this symbol.
    ...
    (number (digit (arbno digit)) number) ; If the scanner finds a number, define it as a value.
